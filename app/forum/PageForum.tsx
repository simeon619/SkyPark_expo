...
const PageForum = ({ route }: any) => {
  ...
  console.log('🚀 ~ PageForum ~ forumData:', forumData.message);
  ...
  const listHeaderComponent = useCallback(() => {
    return (
      <>
        <TextMedium
          style={{ fontSize: 14, color: '#1119', marginHorizontal: moderateScale(7), marginBottom: moderateScale(7) }}
        >
        ...
        <PostFooter
          ...
          data={forumData}
          user={{
            account: { ...forumData.message.account, profile: forumData.message.account.profile._id },
        ...
        >
          <TextLight style={{ fontSize: 14 }}>
            Ce sujet a {forumData.statPost.comments} commentaires cree par {forumData.message.account.name} il y a{' '}
            {
              //@ts-ignore
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      >
        ...
        <Text style={{ fontSize: 16, paddingVertical: 5, paddingHorizontal: moderateScale(10) }}>
          {forumData.theme}
        </Text>
      </Animated.View>
      <Animated.View
        ...
        >
          <Pressable onPress={handleFocus}>
            <TextLight style={{ fontSize: moderateScale(15), flex: 1, marginVertical: verticalScale(5) }}>
              ...
              <TextLight style={{ color: primaryColour }}>@{forumData.message.account.name}</TextLight>
            </TextLight>
          </Pressable>
          <Ionicons
            name="camera-outline"
