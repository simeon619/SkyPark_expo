		...
		>
			...
			<ScrollView style={{ flex: 1 }}>
				...
				<View style={{ marginTop: horizontalScale(166 / 2), alignItems: 'center' }}>
					<Pressable style={{ backgroundColor: 'transparent' }} onPress={() => toggleState()}>
						...
						>
							...
							/>
							<TextLight style={{ fontSize: moderateScale(17), marginTop: verticalScale(3) }}>
								{name}
							</TextLight>
						</Animated.View>
					</Pressable>
				...
				<View style={{ paddingHorizontal: horizontalScale(20) }}>
					...
					>
						<TextRegular
							style={{ fontSize: moderateScale(17), textAlign: 'center', color: '#444' }}
						>
							Déconnexion
						</TextRegular>
					</TouchableOpacity>
